...
*** Auto-indent code blocks
    ...
    #+begin_src emacs-lisp
      ...
      (spacemacs/set-leader-keys-for-major-mode 'org-mode "i" 'indent-org-src-block-automatically)
    #+end_src
        ...
        (defun ik/pytest-param-with-id ()
          ...
          (let ((inner-paren (evil-select-paren "(" ")" nil nil nil 1 nil))
            ...
            ((evil-visual-select (car inner-paren) (car (cdr inner-paren)))
             (yas-expand-snippet "pytest.param($0, id=\"$1\")" (car outer-paren) (car (cdr outer-paren))))))
      #+end_src
