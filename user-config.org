...
**** Long breaks and blocks of pomodoros
     ...
     Moreover, I also set the expiration time for a block to that time because even if I did 3 or even 2 pomodoros and then took a long break, I have finished a block.
    #+begin_src emacs-lisp :tangle yes :results silent
      (setq org-pomodoro-long-break-length 25)
      (setq org-pomodoro-expiry-time org-pomodoro-long-break-length)
    #+end_src
